...
- **Trip history:** **`GET /driver/trips`** (optional `DRIVER_TRIP_HISTORY_HTTP_PATH` override) for **Safarlar tarixi** — status, date, trip price, and service fee when the API sends them.
