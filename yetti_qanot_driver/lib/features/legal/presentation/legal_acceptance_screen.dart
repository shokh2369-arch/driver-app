...
class _LegalAcceptanceScreenState extends ConsumerState<LegalAcceptanceScreen> {
  ...
  /// Never fall back to `Map.toString()` — dumping the raw JSON envelope into a document
  /// the driver has to legally accept is worse than admitting it failed to load.
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                ...
                child: DecoratedBox(
                  ...
                  child: _loadError != null
                      ...
                      : _active == null
                          ...
                          : Builder(
                              builder: (context) {
                                final text = _summaryText(_active!);
                                if (text == null) {
                                  return Center(
                                    child: Padding(
                                      padding: const EdgeInsets.all(16),
              ...
              const SizedBox(height: 16),
              FilledButton(
                // Do not let the driver accept a document whose text failed to render.
                onPressed:
                    _submitting ||
                        _active == null ||
                        _summaryText(_active!) == null
                    ? null
                    : _accept,
                child: _submitting
