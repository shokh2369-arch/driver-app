...
abstract class AppLocalizations {
  ...
  ///
  /// In uz, this message translates to:
  /// **'Hozircha bu yerda safarlar yo‘q.'**
  String get trip_history_empty;

  /// No description provided for @trip_history_load_error.
  ///
  /// In uz, this message translates to:
  /// **'Tarixni yuklab bo‘lmadi. Internetni tekshiring.'**
  String get trip_history_load_error;

  /// No description provided for @trip_history_status_label.
  ///
  /// In uz, this message translates to:
  /// **'Holat'**
  String get trip_history_status_label;

  /// No description provided for @trip_history_date_label.
  ///
  /// In uz, this message translates to:
  /// **'Sana'**
  String get trip_history_date_label;

  /// No description provided for @trip_history_service_fee_label.
  ///
  /// In uz, this message translates to:
  /// **'Xizmat haqi'**
  String get trip_history_service_fee_label;

  /// No description provided for @trip_history_status_completed.
  ///
  /// In uz, this message translates to:
  /// **'Yakunlangan'**
  String get trip_history_status_completed;

  /// No description provided for @trip_history_status_cancelled.
  ///
  /// In uz, this message translates to:
  /// **'Bekor qilingan'**
  String get trip_history_status_cancelled;

  /// No description provided for @trip_history_status_in_progress.
  ///
  /// In uz, this message translates to:
  /// **'Jarayonda'**
  String get trip_history_status_in_progress;

  /// No description provided for @trip_history_status_unknown.
  ///
  /// In uz, this message translates to:
  /// **'Boshqa'**
  String get trip_history_status_unknown;
  ...
  /// No description provided for @phone_login_server_unavailable.
  ///
  /// In uz, this message translates to:
  ...
  /// No description provided for @estimated_price_label.
  ///
  /// In uz, this message translates to:
  /// **'Taxminiy narx'**
  String get estimated_price_label;

  /// No description provided for @trip_panel_title.
  ///
  /// In uz, this message translates to:
  /// **'Safar'**
  String get trip_panel_title;

  /// No description provided for @accept_failed.
  ///
  /// In uz, this message translates to:
  /// **'Buyurtmani qabul qilib bo‘lmadi. Qayta urinib ko‘ring.'**
  String get accept_failed;

  /// No description provided for @accept_requires_online.
  ///
  /// In uz, this message translates to:
  /// **'Buyurtmani qabul qilish uchun ONLINE bo‘ling.'**
  String get accept_requires_online;

  /// No description provided for @cancel_trip_confirm_title.
  ///
  /// In uz, this message translates to:
  /// **'Safarni bekor qilasizmi?'**
  String get cancel_trip_confirm_title;

  /// No description provided for @cancel_trip_confirm_body.
  ///
  /// In uz, this message translates to:
  ...
  /// No description provided for @cancel_trip_confirm_yes.
  ///
  /// In uz, this message translates to:
  /// **'Ha, bekor qilish'**
  String get cancel_trip_confirm_yes;
  ...
  /// No description provided for @launch_dialer_failed.
  ///
  /// In uz, this message translates to:
  /// **'Qo‘ng‘iroq ilovasini ochib bo‘lmadi.'**
  String get launch_dialer_failed;

  /// No description provided for @launch_maps_failed.
  ///
  /// In uz, this message translates to:
  /// **'Xarita ilovasini ochib bo‘lmadi.'**
  String get launch_maps_failed;

  /// No description provided for @dispatch_unreachable.
  ///
  /// In uz, this message translates to:
  /// **'Buyurtmalar ro‘yxatini yangilab bo‘lmayapti. Internet aloqasini tekshiring.'**
  String get dispatch_unreachable;

  /// No description provided for @coordinates_unavailable.
  ///
  /// In uz, this message translates to:
  /// **'Koordinatalar yo‘q'**
  String get coordinates_unavailable;

  /// No description provided for @pickup_coordinates_missing.
  ///
  /// In uz, this message translates to:
  /// **'Olib ketish nuqtasi koordinatalari kelmadi — dispetcherga murojaat qiling.'**
  String get pickup_coordinates_missing;

  /// No description provided for @offline_saved_locally.
  ///
  /// In uz, this message translates to:
  ...
  /// In uz, this message translates to:
  /// **'Komissiya olinmaydi'**
  String get commission_off;

  /// No description provided for @conn_backend_unreachable.
  ///
  /// In uz, this message translates to:
  /// **'Server bilan aloqa yo‘q — birozdan so‘ng qayta urinib ko‘ring.'**
  String get conn_backend_unreachable;

  /// No description provided for @conn_no_internet.
  ///
  /// In uz, this message translates to:
  /// **'Internet aloqasi yo‘q. Ulanishni tekshiring.'**
  String get conn_no_internet;

  /// No description provided for @conn_server_error.
  ///
  /// In uz, this message translates to:
  /// **'Serverda nosozlik. Birozdan so‘ng qayta urinib ko‘ring.'**
  String get conn_server_error;

  /// No description provided for @conn_checking.
  ///
  /// In uz, this message translates to:
  /// **'Server bilan aloqa tekshirilmoqda…'**
  String get conn_checking;

  /// No description provided for @phone_login_code_already_sent.
  ///
  /// In uz, this message translates to:
  /// **'Kod allaqachon yuborilgan — Telegram botni tekshiring.'**
  String get phone_login_code_already_sent;

  /// No description provided for @phone_login_have_code.
  ///
  /// In uz, this message translates to:
  /// **'Kodim bor'**
  String get phone_login_have_code;

  /// No description provided for @awaiting_approval_title.
  ///
  /// In uz, this message translates to:
  /// **'Tasdiqlash kutilmoqda'**
  String get awaiting_approval_title;

  /// No description provided for @awaiting_approval_message.
  ///
  /// In uz, this message translates to:
  ...
  /// No description provided for @awaiting_approval_check_again.
  ///
  /// In uz, this message translates to:
  /// **'Qayta tekshirish'**
