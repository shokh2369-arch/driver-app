...
class DriverRepository {
  ...
  Future<Map<String, dynamic>> getAvailableRequests({int? waitSec}) =>
      _api.getAvailableRequests(waitSec: waitSec);

  Future<dynamic> getDriverTripHistory({int? limit, int? offset}) =>
      _api.getDriverTripHistory(limit: limit, offset: offset);
  ...
  Future<void> postDriverOnline() => _api.postDriverOnline();
